...
class ChooseEnjoyActionWidget extends StatefulWidget {
  const ChooseEnjoyActionWidget({super.key});

  @override
  State<ChooseEnjoyActionWidget> createState() =>
      _ChooseEnjoyActionWidgetState();
}

class _ChooseEnjoyActionWidgetState extends State<ChooseEnjoyActionWidget> {
  final listChoice = [
    'Action',
    'Comedy',
    'Drama',
